...
const HomePage = () => {
  ...
  const { isLoadingUserProfiles, getUserProfiles, userProfile, subscribeToNewMatch, unSubscribeFromNewMatch } = useMatchStore();
  ...
  }, [subscribeToNewMatch, unSubscribeFromNewMatch, authUser])
     ...
     <Sidebar />
      ...
      <div className="flex-grow flex flex-col overflow-hidden">
        ...
        <main className="flex-grow flex flex-col gap-10 justify-center items-center p-4 relative overflow-hidden">
          {userProfile.length > 0 && !isLoadingUserProfiles && (
            <>
             <SwipeArea />
             <SwipeFeedback />
            </>
